...
class FavWhoArrived extends StatefulWidget {
  @override
  _FavWhoArrivedState createState() => _FavWhoArrivedState();
}

class _FavWhoArrivedState extends State<FavWhoArrived> {
  SharedPreferences _sharedPreferences;
  String _id;
  String profileUrl;
  FavDelete _favDelete = new FavDelete();
  MyFavOfFunction _myFavOfFunction;
                                  ...
                                  Container(
                                    ...
                                    child: new Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        InkWell(
                                          onTap: () {
                                            _favDelete.favDelete(all[index].eventId);
                                            setState(() {
                                              FavWhoArrived();
                                            });
