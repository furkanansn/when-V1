...
class AltDetail extends StatefulWidget {
  List<dynamic> all;
  int index;

  AltDetail(this.all, this.index);

  @override
  _AltDetailState createState() => _AltDetailState();
}

class _AltDetailState extends State<AltDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[topContent,Container(height: 5,),whoButton, bottomContent],
        ),
      ),
    );
  }
