...
class AnotherProfile extends StatefulWidget {
  ...
  @override
  _AnotherProfileState createState() => _AnotherProfileState(id);
}

class _AnotherProfileState extends State<AnotherProfile> {
  String _id;

  _AnotherProfileState(this._id);
  ...
  Widget _buildProfileImage() {
    return Center(
      ...
      children: <Widget>[
        ClipOval(
          child: Image.network(
            _userPhoto == null ? "http://www.whentimee.com//upload//user_photos//default.png" : _userPhoto,
            width: 300,
            height: 300,
            fit: BoxFit.cover,
          ),
  ...
  Widget _buildButtons(context, String id) {
    return Padding(
            ...
            child: InkWell(
              onTap: () => Navigator.push(
                  ...
                  new MaterialPageRoute(
                      builder: (context) =>
                          AnotherFav(_id, _usernameController))),
              child: Container(
                height: 40.0,
                decoration: BoxDecoration(
                  border: Border.all(),
